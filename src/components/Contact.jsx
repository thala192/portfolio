...
import { emailConfig } from "../constants"; // Import the entire emailConfig object
...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const { EMAIL_JS_SERVICE_ID, EMAIL_JS_TEMPLATE_ID, EMAIL_JS_PUBLIC_KEY } = emailConfig; // Destructure from emailConfig
    ...
    emailjs
      .send(
        ...
        {
          from_name: username,
          to_name: "Battu Chaitanya",
          reply_to: user_email,
          to_email: "chaitanyabattu7766@gmail.com",
